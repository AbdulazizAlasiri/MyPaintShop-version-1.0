...
public class RectangleClass extends Shape {
	...
	public RectangleClass(javafx.scene.paint.Color Shapecolor,javafx.scene.paint.Color fillColor,  XY firstCoordinate, XY secondCoordinate) {
	...
	public String toString() {
		...
		return "rectangle" +  " " +fillColor +" "+shapeColor + " "  + firstCoordinate+" "
				+ secondCoordinate + "\n";
	}
