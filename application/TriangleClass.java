...
public class TriangleClass extends Shape {
	...
	public TriangleClass(javafx.scene.paint.Color Shapecolor ,javafx.scene.paint.Color fillColor, XY firstCoordinate, XY secondCoordinate) {
	...
	public String toString() {
		...
		return "triangle" + " " +fillColor +" "+shapeColor +" " + firstCoordinate
				+" "	+ secondCoordinate  +"\n";
	}
